...
namespace caches {
    ...
    public:
        tree_node(T page) : page(page), freq(0) {}
    ...
    class pointer_less {
    public:
        bool operator()(const tree_node<T> *lv, const tree_node<T> *rv) const {
            return (*lv) < (*rv);
        }
    };
    ...
    public:
        lfu_cache(size_t max_size) : max_size(max_size) {}
